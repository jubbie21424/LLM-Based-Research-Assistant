...
# Regular expressions library for pattern matching (used to remove citations when counting words)
import re
...
# =============================================================================
        ...
        try:
            ...
            # System prompt with stronger word limit emphasis
            ...
            # User prompt with word allocation per section
            ...
            # Multiple attempts to get under 500 words
            max_attempts = 3
            attempt = 0
            word_count = 0
            ...
            while attempt < max_attempts:
                ...
                # Remove citations before counting words
                content_without_citations = re.sub(r'\[.*?\]', '', response.content)
                word_count = len(content_without_citations.split())
